-- Reconciles the migration already applied to production on 2026-09-14.
-- The remote revision cast auth.users.email to text. Keep the local replay
-- secure as well, so a clean database gets the intended final permissions.
