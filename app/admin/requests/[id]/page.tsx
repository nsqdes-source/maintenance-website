  ...
  const { data: requestPayments } =
    ...
    await supabase
      ...
      .select(
        ...
        "id,payment_type,amount,method,note,paid_at,voided_at,transferred_invoice_payment_id"
        ...
        <section className="requestDetailGrid">
          ...
          <article className="card detailCard">
            ...
            profile.role === "super_admin" ? (
              <ServiceRequestPaymentControl
                requestId={request.id}
                payments={(requestPayments ?? []).map(
                  (payment) => ({
                    ...payment,
