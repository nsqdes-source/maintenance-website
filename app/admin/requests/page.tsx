...
export default async function AdminRequestsPage() {
  ...
  const [{ data: requests, error }, { data: technicians }, { data: assignments }] = await Promise.all([
    supabase.from("service_requests").select("id, customer_name, phone, service_type, problem_description, city, address, workflow_stage, visit_notes, created_at").order("created_at", { ascending: false }),
