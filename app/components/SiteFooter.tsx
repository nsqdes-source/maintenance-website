...
export default async function SiteFooter({ order }: { order?: number }) {
  ...
  const whatsappIconUrl = "/whatsapp.png";
      ...
      <div className="container footerInner">
        <section className="footerBrand">
          ...
          <p className="footerDescription">
            {data?.description ?? "معين.. الصيانة أسهل"}
          </p>
        ...
        <section className="footerLinks">
          ...
          {settings.footer_request_cta_visible !== "false" ? (
            <Link href="/request">
          ...
          <Link href="/warranty">
            {t("سياسة الضمان", "Warranty")}
          </Link>

          <Link href="/service-policy">
            {t("سياسة الخدمة", "Service policy")}
          </Link>

          {data?.business_center_url ? (
            <a
              className="businessCentreLink"
              href={data.business_center_url}
            >
              <span className="businessCentreLogo">
                {data.business_center_logo_url ? (
                  <img
                    src={data.business_center_logo_url}
                    alt=""
                  />
                ) : (
                  "▦"
        ...
        <section className="footerPayment">
          ...
          <p>
            {t(
              "اخترنا الوسائل التي تناسب خدماتنا.",
